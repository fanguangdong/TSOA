...
<link href="css/skins/sky/import_skin.css" rel="stylesheet" type="text/css" id="skin" themeColor="sky"/>
	...
	<div id="bs_bannerright">
		...
		<div class="bs_nav">
			<div class="bs_navleft">
				<li>
					欢迎<b> <s:property value="#session.user.name"/> </b>用户，今天是
				<script>
			...
			<div class="bs_navright">
				...
				<span class="icon_no hand" onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="user_logout.action"});'>退出系统</span>
...
<div id="fbox">
	...
	<div id="bs_footleft">
	<div id="bs_footright">
		大连天时传媒有限公司 COPYRIGHT 2014 @ www.ts987.cn
	</div>
	</div>
	</div>
</div>
