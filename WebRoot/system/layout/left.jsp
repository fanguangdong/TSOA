...
<script type="text/javascript">
	var zNodes =[
		...
		{ id:101, parentId:3001, name:"审批流程管理",url:"processDefinition_list.action", target:"frmright",iconOpen:"libs/icons/folder_doc.gif",iconClose:"libs/icons/folder_doc.gif",icon:"system/layout/skin/titlebar_arrow.gif"},
